        ...
        <div class="container">
            <div class="well">
                ...
                <div class="btn-group btn-group-justified">
                    <a href="Carport1.jsp" class="btn btn-danger">Carport 1</a>
                        ...
                        <div class="container">	
                            <div class="col-md-12">
                                <div class="product col-md-3 service-image-left">
                                    ...
                                    <center>
                                        <img id="item-display" src="Images/carport1.jpg" alt=""></img>
                                    </center>
                                ...
                                <%                                    Carport visOrdre = cm.getCarport(1);
